...
saveRDS(GO_score, paste0(pathwayofinterest,'_score.rds'))
...
#2023-03-13: color by Score for IL18 pathway genes (enrichment result from Kathrien)
load('rd2')
load('crv2')
...
for (i in nms) {
  ...
  lines(crv2, lwd = 3, col = 'black'#, type = 'lineages'
  )
}
dev.off()
